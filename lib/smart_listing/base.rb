    ...
    def setup(params, cookies)
      ...
      if @options[:array]
        ...
        if @options[:paginate] && @per_page > 0
          @pagy_collection, @collection = pagy_array(@collection, page: @page, limit: @per_page, params: pagy_options[:params])
        ...
        @pagy_collection, @collection = pagy(@collection, page: @page, limit: @per_page, params: pagy_options[:params]) if @options[:paginate] && @per_page > 0
      end
    end
